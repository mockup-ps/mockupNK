              ...
              <CRow className="px-2">                 
                  ...
                  scopedSlots={{
                      ...
                      (item)=>{
                          return(
                              <td>
                                  <CButton disabled className="btn btn-sm btn-success">Lihat</CButton>{' '}
                                  <CButton disabled className="btn btn-sm btn-warning">Edit</CButton>{' '}
                                  <CButton disabled className="btn btn-sm btn-danger">Hapus</CButton>
                              </td>
                          )
                      }
                  }}
